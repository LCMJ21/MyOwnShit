...
public class AutocarroInteligente extends Veiculo implements BonificaKms {
    ...
    public AutocarroInteligente(String id, String marca, String modelo, int ano, double velMediaPorKm,
                                double precoTeoricoPorKm, List<Integer> classificacoes, int kms, int lotacao, int pontosPorKm) {
    ...
    public AutocarroInteligente(String id, String marca, String modelo, int ano, double velMediaPorKm,
                                double precoTeoricoPorKm, ArrayList<Integer> classificacoes, int kms, int kmsUltimo, int lotacao, int pontosPorKm) {
