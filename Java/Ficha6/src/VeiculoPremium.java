...
public class VeiculoPremium extends Veiculo implements BonificaKms{
    ...
    public VeiculoPremium(String id, String marca, String modelo, int ano, double velMediaPorKm,
                          double precoTeoricoPorKm, List<Integer> classificacoes, int kms, double taxaDeLuxo, int pontosPorKm) {
    ...
    public VeiculoPremium(String id, String marca, String modelo, int ano, double velMediaPorKm,
                          double precoTeoricoPorKm, ArrayList<Integer> classificacoes, int kms, int kmsUltimo, double taxaDeLuxo, int pontosPorKm) {
    ...
    public double custoRealKM() {
        return this.getPrecokm() * this.taxaDeLuxo;
    }
